...
public class LoggerAspect {
	...
	@Before("execution(* com.demo.*.add (..))")
	public void add() {
		logger.info("INSERT EXECUTION EXPRESS MOVIE AOP");
	}
	
	@Before("execution(* com.demo.Service.MovieService.searchBasedOnTitle (..))")
	public void SearchImpl() {
		logger.info("---------SEARCH ----------");
	}
	@Before("execution(* com.demo.Service.MovieService.getDirectorListFromTitle (..))")
